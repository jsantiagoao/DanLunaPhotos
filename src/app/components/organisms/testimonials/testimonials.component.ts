import {
  ...
  Inject, PLATFORM_ID, ChangeDetectionStrategy, signal
} from '@angular/core';
...
export class TestimonialsComponent implements OnInit, OnDestroy {
  ...
  prev(): void {
    this.currentIndex.set(this.currentIndex() > 0 ? this.currentIndex() - 1 : this.maxIndex);
    this.resetAutoplay();
  }

  next(): void {
    this.currentIndex.set(this.currentIndex() < this.maxIndex ? this.currentIndex() + 1 : 0);
    this.resetAutoplay();
  }
