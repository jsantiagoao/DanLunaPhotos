import { Component, Inject, OnDestroy, OnInit, PLATFORM_ID, ChangeDetectionStrategy, signal } from '@angular/core';
...
export class LoaderComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.timers.push(setTimeout(() => {
      ...
      this.timers.push(setTimeout(() => this.isLoading.set(false), LOADER_FADE_MS));
    }, LOADER_VISIBLE_MS));
  }
