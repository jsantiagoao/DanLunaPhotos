...
export class MothersDayComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    canonical.setAttribute('href', 'https://danlunaphotos.com/dia-de-las-madres');

    // ── Open Graph — Facebook, WhatsApp, LinkedIn, Telegram ─────────────
    const ogImage = 'https://danlunaphotos.com/assets/images/slider/Sesion-dia-de-las-madres-queretaro.jpeg';
    ...
    this.metaService.updateTag({ property: 'og:url',              content: 'https://danlunaphotos.com/dia-de-las-madres' });
    ...
    this.jsonLdScript.text = JSON.stringify({
      ...
      '@graph': [
        ...
        {
          '@type': 'Service',
          '@id': 'https://danlunaphotos.com/dia-de-las-madres#service',
          ...
          provider: { '@id': 'https://danlunaphotos.com/#business' },
